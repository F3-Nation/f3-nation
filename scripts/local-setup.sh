...
echo ""
echo "    2. (Optional) If you want to run slackbot, you will need to set up a Slack app at https://api.slack.com/apps"
echo "        and populate apps/slackbot/.env with the appropriate credentials."
echo "        See apps/slackbot/README.md for details."
echo ""
