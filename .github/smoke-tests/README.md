...
[#841](https://github.com/F3-Nation/f3-nation/issues/841) for that). `api`'s
authenticated routes are checked indirectly, through the map and me/admin
apps, rather than called directly.
