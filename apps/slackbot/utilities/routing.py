...
VIEW_MAPPER = {
    ...
    actions.KOTTER_REPORT_CONFIG_CALLBACK_ID: (config.handle_kotter_report_config_post, False),
...
ACTION_MAPPER = {
    ...
    actions.BACKBLAST_EDIT_BUTTON_LEGACY: (backblast.handle_legacy_edit_button, True),
    ...
    actions.CONFIG_KOTTER_REPORTS: (config.build_kotter_report_config_form, False),
    ...
    location.CALENDAR_MANAGE_LOCATIONS: (location.manage_locations, False),
    ...
    event_type.CALENDAR_MANAGE_EVENT_TYPES: (event_type.manage_event_types, False),
    location.CALENDAR_ADD_AO_NEW_LOCATION: (location.build_location_add_form, False),
