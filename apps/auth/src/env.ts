...
export const env = createEnv({
  server: {
    ...
    // Better Auth's own session-signing secret — deliberately separate key
    // material from AUTH_SECRET, which stays exclusively NextAuth's.
    // Optional here (checked at the point of use in
