...
# Push secrets and env vars to GCP Cloud Run for the f3-admin service.
#
# Usage:
#   bash apps/admin/scripts/cloud-run-env.sh --env staging
#   bash apps/admin/scripts/cloud-run-env.sh --env prod
#
...
#   - apps/admin/.env.cloud-run.prod / apps/admin/.env.cloud-run.staging populated
...
declare -A PROJECT_MAP=(
  [staging]="f3-admin-portal-staging"
  [prod]="f3-admin-portal"
)
