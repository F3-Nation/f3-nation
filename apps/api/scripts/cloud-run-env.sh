...
# Push secrets and env vars to GCP Cloud Run for the f3-api service.
#
# Usage:
#   bash apps/api/scripts/cloud-run-env.sh --env staging
...
#   - apps/api/.env.cloud-run.prod / apps/api/.env.cloud-run.staging populated
