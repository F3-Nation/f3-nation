...
1. Fork the `main` branch into your own account.
1. Make something awesome.
1. Submit a PR against the F3-Nation `main` branch in **DRAFT**.
1. Make sure all Checks pass. Fix code if they don't.
1. Set PR to **Open**. At this point, a number of AI bots will run and provide feedback.
