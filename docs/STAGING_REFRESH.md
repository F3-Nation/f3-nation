...
| `auth.better_auth_jwks`                                                                                                                                                          | all                                                       | TRUNCATE                | `private_key` — the signing keys for every token the auth app issues. Must never exist outside prod; Better Auth generates a fresh keypair on demand when the table is empty                                                                                                                                                                                                                         |
...
| `auth.better_auth_oauth_client`                                                                                                                                                  | `jwks`, `jwks_uri`, `name`, `uri`, `redirect_uris`, …     | KEEP                    | The CLIENT's public key set and its registration config — public by definition, no PII                                                                                                                                                                                                                                                                                                               |
