...
CREATE INDEX "idx_event_instances_start_date_active" ON "event_instances" USING btree ((start_date) WHERE (is_active));--> statement-breakpoint
CREATE INDEX "idx_slack_users_user_team_id" ON "slack_users" USING btree ((user_id), (slack_team_id));--> statement-breakpoint